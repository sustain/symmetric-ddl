...
public class Column implements Cloneable, Serializable {
    ...
    /** The name of the sequence to use for auto-incremenet for databases like Oracle or Postgres */
    private String autoIncrementSequenceName;
    /** Whether the auto-increment sequence should be created at the same time as the table */
    private boolean skipAutoIncrementSequenceCreation;
    ...
    /**
     * Returns the name of the database sequence to use for auto-increment, instead of the automatically default generated by SqlBuilder implementations.
     *
    ...
    /**
     * Sets the name of the database sequence to use for auto-increment
     *
     * @param autoIncrementSequenceName The database sequence name
     */
    ...
    /**
     * Determines whether the auto-increment sequence should be created at the same time as the table
     *
     * @return <code>true</code> if the auto-increment sequence should not be created at the same time as the table
     */
    public boolean isSkipAutoIncrementSequenceCreation() {
        return skipAutoIncrementSequenceCreation;
    }

    /**
     * Specifies whether the auto-increment sequence should be created at the same time as the table
     *
     * @param skipAutoIncrementSequenceCreation    <code>true</code> if the auto-increment sequence should not be created at the same time as the table
     */
    public void setSkipAutoIncrementSequenceCreation(boolean skipAutoIncrementSequenceCreation) {
        this.skipAutoIncrementSequenceCreation = skipAutoIncrementSequenceCreation;
    }
